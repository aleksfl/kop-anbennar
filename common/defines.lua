...
NDiplomacy = {
	...
	DISHONORABLE_PEACE_MONTHS = 1,					-- See DISHONORABLE_PEACE_WARSCORE. Set to 0 to entirely disable the feature.
...
NCountry = {
	...
	PILLAGE_CAPITAL_DEVELOPMENT_DECREASE = 0.2, -- ANBENNAR - disabled concentrate development
	...
	INNOVATIVENESS_FIRST_PICKED_IDEA = 1.5,			-- Innovativeness bonus to first country (or countries) to pick an idea.
...
NMilitary = {
	...
	SCORCHED_DEVASTATION_IMPACT = 25, 					-- how much devastation scorching impacts.
